...
def load_model():
    with open('BCD_app/best_model.sav', 'rb') as file:
...
def main():
    ...
    """)
    st.image("BCD_app/BCD.jpg", caption="Early detection saves lives.", use_container_width=True)
    ...
    """)
    st.image("BCD_app/model.jpg", caption="Early detection saves lives.", use_container_width=True)
